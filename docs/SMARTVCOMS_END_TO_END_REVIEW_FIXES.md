...
| 3 | Rà soát quyền manual action/manual override | MEDIUM/HIGH | DONE / NO CODE CHANGE | Đã xác nhận quyền thao tác thủ công đồng nhất với quyền view tab Quản trị SmartVCOMS, đúng yêu cầu vận hành. Giữ nguyên backend hiện tại. |
...
[ ] Quyền thao tác thủ công đi đúng theo quyền view tab Quản trị SmartVCOMS.
